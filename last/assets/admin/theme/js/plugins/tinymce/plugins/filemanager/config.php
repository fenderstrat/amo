...
$base_url="http://kpu-mukomukokab.go.id"; //url base of site if you want only relative url leave empty
$upload_dir = '/last/assets/admin/images/'; // path from base_url to upload base dir
